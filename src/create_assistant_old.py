...
DATA_BASE = "database/nuroxa-sales.db"
...
async def initialize():
    ...
    instructions = {
        "You are a polite, professional assistant specializing in Nuroxa sales data analysis. Provide clear, concise explanations.",
        ...
        "Only use data from the Nuroxa sales database or uploaded files to respond. If the query falls outside the available data or your expertise, or you're unsure, reply with: I'm unable to assist with that. Please ask more specific questions about Nuroxa sales and products or contact IT for further help.",
